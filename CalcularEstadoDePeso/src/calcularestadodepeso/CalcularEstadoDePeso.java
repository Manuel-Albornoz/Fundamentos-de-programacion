 ...
 * @author ManueloD-21
 */
public class CalcularEstadoDePeso {
    ...
    private static void mostrarMensajeInicial() {
        System.out.println("Calculo de peso ideal by Manu.exe");
    ...
    private static void mostrarEstadoPeso(String nombre, int pesoActual, int pesoIdeal) {
        if(pesoIdeal == pesoActual){
            System.out.println(nombre + "Esta en su peso ideal.");
                ...
                System.out.println(nombre + "Esta con sobre peso");
        }else{
